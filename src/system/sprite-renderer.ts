...
import fragmentShaderSource from ".././shaders/FragShader.glsl?raw";
...
export class SpriteRenderer {
    ...
    private projectiveViewMatrixLocation!: WebGLUniformLocation;
    private camera!: Camera;

    private vao!: WebGLVertexArrayObject;
    private buffer!: WebGLBuffer;
    private indexBuffer!: WebGLBuffer;
    private data: Float32Array = new Float32Array(FLOATS_PER_SPRITE *
    ...
    public async initialise() {
        ...
        this.projectiveViewMatrixLocation = this.gl.getUniformLocation(this.program, "projectionViewMatrix")!;
        ...
        this.gl.vertexAttribPointer(1, 2, this.gl.FLOAT, false, stride, 2 *
            Float32Array.BYTES_PER_ELEMENT);
        this.gl.enableVertexAttribArray(1);

        this.gl.vertexAttribPointer(2, 3, this.gl.FLOAT, false, stride, 4 *
            Float32Array.BYTES_PER_ELEMENT);
    ...
    public drawSprite(texture: Texture, rect: Rect, color: Color = this.defaultColor,
        rotation = 0, rotationOrigin: vec2 | null = null) {
    ...
    public end() {
        ...
        this.gl.drawElements(this.gl.TRIANGLES, 6 * this.instanceCount,
