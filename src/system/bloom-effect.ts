...
export class BloomEffect {
    ...
    constructor(private gl: WebGL2RenderingContext,
        ...
        //describle the buffer
        this.gl.enableVertexAttribArray(0);

        //grabs access point from postPr
        ...
        this.glScenePassTextureLocation = gl.getUniformLocation(this.glProgram,
            "u_texture0")!;
        
        this.glBrightnessBlurTextureLocation = gl.getUniformLocation(this.glProgram,
            "u_texture1")!;
